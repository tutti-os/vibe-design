...
describe('CanvasWorkspace', () => {
  ...
  it('refits html preview zoom to the current viewport when reset is clicked', async () => {
    ...
    try {
      ...
      const resetZoom = screen.getByRole('button', { name: 'Reset canvas zoom' }) as HTMLButtonElement;
