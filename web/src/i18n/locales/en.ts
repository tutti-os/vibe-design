export const en = {
  ...
  chat: {
    ...
    composer: {
      ...
      lockedModelProvider: 'Start a new conversation to switch agents',
      mentionFilterAll: 'All',
      mentionDirectoryBack: 'Back',
      mentionDirectoryEnter: 'Enter folder',
      mentionDirectoryNavigateHierarchy: 'Enter/leave folder',
      mentionFilterFiles: 'Files',
      mentionFilterSkills: 'Skill',
      mentionFilters: 'Mention filters',
      mentionMoveSelection: 'Move selection',
      mentionResults: 'Mention results',
      mentionSwitchTabs: 'Switch tabs',
      message: 'Message',
      messageSendFailed: 'Message send failed',
      model: 'Model',
      modelUnavailable: 'No models available',
      modelProvider: 'Agent and model',
      noContextResults: 'No context results',
      openFileMentions: 'Mention files',
